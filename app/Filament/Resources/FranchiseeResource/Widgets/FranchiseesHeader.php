...
class FranchiseesHeader extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.franchisee-resource.widgets.franchisees-header';
    ...
    public function mount(): void
    {
        ...
        $teamNote = TeamNote::firstOrCreate(
            ['page' => 'franchisees'],
            ['content' => 'Use this page for all approved logo lockups for each franchisee that we work with']
        );
        ...
        $this->content = $content ?: 'Use this page for all approved logo lockups for each franchisee that we work with';
    ...
    public function editNotes(): Action
    {
        return Action::make('edit_notes')
            ...
            ->action(function (array $data): void {
                $teamNote = TeamNote::firstOrNew(['page' => 'franchisees']);
