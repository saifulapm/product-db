...
use App\Models\EmailDraft as EmailDraftModel;
use Filament\Resources\Pages\ManageRecords;

class ManageEmailDrafts extends ManageRecords
{
    protected static string $resource = EmailDraftResource::class;

    protected static string $view = 'filament.resources.email-draft-resource.pages.manage-email-drafts';
    
    public function getEmailDrafts()
    {
        return EmailDraftModel::active()->ordered()->get();
    }
