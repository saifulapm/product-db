...
use App\Filament\Resources\SocksTwoResource\Pages;
use App\Models\Sock;
use Filament\Forms;
...
class SocksTwoResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\SocksTwoGallery::route('/'),
            'create' => Pages\CreateSocksTwo::route('/create'),
            'view' => Pages\ViewSocksTwo::route('/{record}'),
            'edit' => Pages\EditSocksTwo::route('/{record}/edit'),
        ];
    }
}
